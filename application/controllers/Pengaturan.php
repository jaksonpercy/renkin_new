...
class Pengaturan extends MY_Controller {
	...
	{
		parent::__construct();
		$this->page_data['page']->title = 'Pengaturan';
	...
	public function general()
	{
		...
		$this->load->view('pengaturan/general', $this->page_data);
	}
	...
	public function company()
	{
		...
		$this->load->view('pengaturan/company', $this->page_data);
	}

	public function module()
	{
		$this->page_data['page']->submenu = 'module';
		$this->load->view('pengaturan/module', $this->page_data);
	}
	...
	public function login_theme()
	{
		...
		$this->load->view('pengaturan/login_theme', $this->page_data);
	}
	...
	public function email_templates()
	{
		...
		$this->load->view('pengaturan/email_templates/list', $this->page_data);
	}
	...
	public function edit_email_templates($id)
	{
		...
		$this->load->view('pengaturan/email_templates/edit', $this->page_data);
	}
	...
	public function update_email_templates($id)
	{
		...
		redirect('pengaturan/email_templates');
	}
