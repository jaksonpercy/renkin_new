...
<section class="content">
  ...
  <div class="card">
    <div class="card-header with-border">
      <h3 class="card-title"> Tambah Kanal Publikasi / Rencana Media </h3>

      <div class="card-tools pull-right">
        <a href="<?php echo url('KanalPublikasi') ?>" class="btn btn-flat btn-default btn-sm"><i class="fa fa-arrow-left"></i> &nbsp;&nbsp;  Kanal Publikasi </a>
      </div>

    </div>

    <?php echo form_open('KanalPublikasi/save', [ 'class' => 'form-validate' ]); ?>
    <div class="card-body">
