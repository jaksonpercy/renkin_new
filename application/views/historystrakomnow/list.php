...
<section class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1>History Strategi Komunikasi Unggulan Sistem Saat Ini</h1>
      </div>
      <div class="col-sm-6">
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                ...
                <?php echo form_open_multipart('HistoryStrakomNow/strakom', [ 'class' => 'form-validate', 'autocomplete' => 'off','method'=> 'GET' ]); ?>
                <div class="row">
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-hover table-striped">
                  ...
                  <th rowspan="2" style="vertical-align:middle;text-align:center;">No</th>
                    ...
                    <th rowspan="2" style="vertical-align:middle;text-align:center;">Rencana Media/Kanal Publikasi</th><th style="vertical-align:middle;text-align:center;">Tanggal Dibuat</th>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        <a href="<?php echo url('HistoryStrakomNow/view/'.$row->strakom_id) ?>" class="btn btn-sm btn-info" title="Lihat" data-toggle="tooltip"><i class="fa fa-eye"></i></a>
