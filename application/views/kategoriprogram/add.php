...
<section class="content">
  ...
  <div class="card">
    <div class="card-header with-border">
      <h3 class="card-title"> Tambah Kategori Program / Kegiatan </h3>

      <div class="card-tools pull-right">
        <a href="<?php echo url('KategoriProgram') ?>" class="btn btn-flat btn-default btn-sm"><i class="fa fa-arrow-left"></i> &nbsp;&nbsp;  Kategori Program </a>
      </div>

    </div>

    <?php echo form_open('KategoriProgram/save', [ 'class' => 'form-validate' ]); ?>
    <div class="card-body">
