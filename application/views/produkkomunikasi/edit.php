...
<section class="content">
  ...
  <div class="card">
    <div class="card-header with-border">
      <h3 class="card-title">Edit Produk Komunikasi</h3>

      <div class="card-tools pull-right">
        <a href="<?php echo url('ProdukKomunikasi') ?>" class="btn btn-flat btn-default"><i class="fa fa-chevron-left"></i> &nbsp;&nbsp; Produk Komunikasi</a>
      </div>

    </div>

    <?php echo form_open('ProdukKomunikasi/update/'.$produkkomunikasi->id, [ 'class' => 'form-validate' ]); ?>
    <div class="card-body">

      <div class="form-group">
        <label for="formClient-Name"> Nama Produk Komunikasi</label>
        <input type="text" class="form-control" name="name" id="formClient-Name" required placeholder="Enter Name" value="<?php echo $produkkomunikasi->nama ?>" autofocus />
      </div>

      <div class="form-group">
        <label for="formClient-Code"> <?php echo lang('permission_code') ?></label>
        <input type="text" class="form-control" name="code" id="formClient-Code" required placeholder="Enter Code" value="<?php echo $produkkomunikasi->code ?>" autofocus />
      ...
      <div class="form-group">
        ...
        <select name="status" id="formClient-Status" class="form-control">
          <?php $sel = $produkkomunikasi->status==1 ? 'selected' : '' ?>
          <option value="1" <?php echo $sel ?>><?php echo lang('user_active') ?></option>
          <?php $sel = $produkkomunikasi->status==0 ? 'selected' : '' ?>
