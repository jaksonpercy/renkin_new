...
<section class="content">
  ...
  <div class="card">
    <div class="card-header with-border">
      <h3 class="card-title"> Tambah KSD </h3>

      <div class="card-tools pull-right">
        <a href="<?php echo url('KSD') ?>" class="btn btn-flat btn-default btn-sm"><i class="fa fa-arrow-left"></i> &nbsp;&nbsp;  KSD </a>
      </div>

    </div>

    <?php echo form_open('KSD/save', [ 'class' => 'form-validate' ]); ?>
    <div class="card-body">
