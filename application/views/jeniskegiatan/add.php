...
<section class="content">
  ...
  <div class="card">
    <div class="card-header with-border">
      <h3 class="card-title"> Tambah Jenis Kegiatan </h3>

      <div class="card-tools pull-right">
        <a href="<?php echo url('JenisKegiatan') ?>" class="btn btn-flat btn-default btn-sm"><i class="fa fa-arrow-left"></i> &nbsp;&nbsp;  Jenis Kegiatan </a>
      </div>

    </div>

    <?php echo form_open('JenisKegiatan/save', [ 'class' => 'form-validate' ]); ?>
    <div class="card-body">

      <div class="form-group">
        <label for="formClient-Name"> Nama Jenis Kegiatan</label>
